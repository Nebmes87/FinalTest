...
public class Main {
    public static void main(String[] args) {
        ...
        animalFarm.adopt(new Cat(1009, "Маруся", "2009-12-12", true));
        animalFarm.adopt(new Donkey(1019, "Джек", "2019-01-12", 12));
        animalFarm.adopt(new Camel(1091, "Горыныч", "2016-07-15", 15));
        animalFarm.adopt(new Dog(1209, "Бой", "2018-07-15", false));
